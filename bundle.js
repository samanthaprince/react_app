...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(AppComponent, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _addTodo2 = __webpack_require__(169);

	var _addTodo3 = _interopRequireDefault(_addTodo2);

	var _stateFunctions = __webpack_require__(170);
	...
	var Todos = function (_React$Component) {
	  ...
	  function Todos(props) {
	    ...
	    _this.state = {
	      todos: [{ id: 1, name: 'Make a React app', done: false }, { id: 2, name: 'Add tests', done: false }, { id: 3, name: 'Pass 401 and get job', done: false }]
	    };
	    return _this;
	  }
	  ...
	  _createClass(AddTodo, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'add-todo' },
	        _react2.default.createElement('input', { type: 'text', placeholder: 'feed the dog', ref: 'todoTitle' }),
	        _react2.default.createElement(
	          'button',
